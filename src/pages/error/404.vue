<template>
  <div style="background:#f0f2f5;margin-top: -20px;height:100%;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops font-primary">ERROR!</div>
        <div class="bullshit__info">访问出错</div>
        <div class="bullshit__headline font-primary">Sorry！页面不存在或已删除~</div>
        <div class="bullshit__info pt-10">请检查您输入的网址是否正确，点击按钮返回</div>
...
export default {
  ...
  data() {
    return {
      img404: 'assets/images/error/404.png',
      img404Cloud: 'assets/images/error/404_cloud.png',
    };
  },
  computed: {
  },
